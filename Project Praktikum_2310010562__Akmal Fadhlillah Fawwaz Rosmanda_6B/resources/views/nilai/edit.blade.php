            ...
            <form action="{{ route('nilai.update', $nilai->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="mata_kuliah" id="mata_kuliah" class="form-select @error('mata_kuliah') is-invalid @enderror" required>
                        ...
                        <option value="Pemrograman Web 3" {{ old('mata_kuliah', $nilai->mata_kuliah) == 'Pemrograman Web 3' ? 'selected' : '' }}>Pemrograman Web 3</option>
                        <option value="Sistem Basis Data" {{ old('mata_kuliah', $nilai->mata_kuliah) == 'Sistem Basis Data' ? 'selected' : '' }}>Sistem Basis Data</option>
                        <option value="Multimedia" {{ old('mata_kuliah', $nilai->mata_kuliah) == 'Multimedia' ? 'selected' : '' }}>Multimedia</option>
                    </select>
